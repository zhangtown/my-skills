---
name: kimi-excel
description: Create and analyze Excel spreadsheets (.xlsx/.csv) using Python + openpyxl/pandas. Supports formula-driven analysis, charts, conditional formatting, styled reports, data cleaning, and financial modeling. Use when the user needs to read, write, modify, or analyze Excel files.
---
...
```bash
python "$HOME/.pi/agent/skills/kimi-excel/scripts/xlsx_tools.py" recalc output.xlsx
```
...
```bash
python "$HOME/.pi/agent/skills/kimi-excel/scripts/xlsx_tools.py" verify output.xlsx
```
